"""A Python module to organize all Slack API methods."""
...
class SlackAPIMixin(object):
    """The SlackAPIMixin implements all available API Calls
    as specified in the `Slack Web API Docs <https://api.slack.com/web>`
    """
