...
class WebClient(BaseClient):
    ...
    def admin_barriers_create(
        ...
        **kwargs
        ...
        return self.api_call("admin.barriers.create", json=kwargs)
    ...
    def admin_barriers_delete(self, *, barrier_id: str, **kwargs) -> SlackResponse:
        ...
        return self.api_call("admin.barriers.delete", json=kwargs)

    def admin_barriers_list(self, **kwargs) -> SlackResponse:
        """Get all Information Barriers for your organization."""
        return self.api_call("admin.barriers.list", json=kwargs)
    ...
    def admin_barriers_update(
        ...
        **kwargs
        ...
        if isinstance(restricted_subjects, list):
            ...
            kwargs.update({"restricted_subjects": restricted_subjects})
        return self.api_call("admin.barriers.update", json=kwargs)
