...
2.  Make a pull request, get reviewer approval, and merge.
...
3.  Distribute the release
    ...
    *  Create a GitHub Release. You will select the commit with updated version number (e.g. `1.0.6`) to associate with
