...
class TestWebClientCoverage(unittest.TestCase):
    # 307 endpoints as of May 24, 2026
    ...
    async def run_method(self, method_name, method, async_method):
        ...
        if callable(method):
            ...
            elif method_name == "admin_users_getExpiration":
                self.api_methods_to_call.remove(method(user_id="W123", target_team="T123")["method"])
                await async_method(user_id="W123", target_team="T123")
