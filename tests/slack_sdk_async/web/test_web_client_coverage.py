...
class TestWebClientCoverage(unittest.TestCase):
    # 318 endpoints as of September 23, 2026
    ...
    async def run_method(self, method_name, method, async_method):
        ...
        if callable(method):
            if method_name == "admin_analytics_getFile":
            ...
            elif method_name == "agents_conversations_create":
                self.api_methods_to_call.remove(
                    method(name="Fix flaky test", origin_channel_id="C123", origin_message_ts="1717171717.123456")["method"]
                )
            ...
            elif method_name == "apps_user_connection_update":
                self.api_methods_to_call.remove(method(user_id="U12345678", status="connected")["method"])
                await async_method(user_id="U12345678", status="connected")
                ...
                self.api_methods_to_call.remove(method(query="Slack")["method"])
                await async_method(query="Slack")
            elif method_name == "slackLists_access_delete":
                self.api_methods_to_call.remove(method(list_id="123")["method"])
                await async_method(list_id="123")
            elif method_name == "slackLists_access_set":
                self.api_methods_to_call.remove(method(list_id="123", access_level="private")["method"])
                await async_method(list_id="123", access_level="private")
            elif method_name == "slackLists_create":
                self.api_methods_to_call.remove(method(name="Backlog")["method"])
                await async_method(name="Backlog")
            elif method_name == "slackLists_download_get":
                self.api_methods_to_call.remove(method(list_id="123", job_id="123")["method"])
                await async_method(list_id="123", job_id="123")
            elif method_name == "slackLists_download_start":
                self.api_methods_to_call.remove(method(list_id="123")["method"])
                await async_method(list_id="123")
            elif method_name == "slackLists_items_create":
                self.api_methods_to_call.remove(method(list_id="123")["method"])
                await async_method(list_id="123")
            elif method_name == "slackLists_items_delete":
                self.api_methods_to_call.remove(method(list_id="123", id="123")["method"])
                await async_method(list_id="123", id="123")
            elif method_name == "slackLists_items_deleteMultiple":
                self.api_methods_to_call.remove(method(list_id="123", ids=["123", "456"])["method"])
                await async_method(list_id="123", ids=["123", "456"])
            elif method_name == "slackLists_items_info":
                self.api_methods_to_call.remove(method(list_id="123", id="123")["method"])
                await async_method(list_id="123", id="123")
            elif method_name == "slackLists_items_list":
                self.api_methods_to_call.remove(method(list_id="123")["method"])
                await async_method(list_id="123")
            elif method_name == "slackLists_items_update":
                self.api_methods_to_call.remove(
                    method(list_id="123", cells=[{"column_id": "col123"}, {"row_id": "row123"}])["method"]
                )
                await async_method(list_id="123", cells=[{"column_id": "col123"}, {"row_id": "row123"}])
            elif method_name == "slackLists_update":
                self.api_methods_to_call.remove(method(id="123")["method"])
                await async_method(id="123")
