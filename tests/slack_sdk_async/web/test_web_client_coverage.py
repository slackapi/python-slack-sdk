...
class TestWebClientCoverage(unittest.TestCase):
    # 318 endpoints as of August 19, 2026
    ...
    async def run_method(self, method_name, method, async_method):
        ...
        if callable(method):
            ...
            elif method_name == "codeChannels_archive":
                self.api_methods_to_call.remove(method(channel_id="C123")["method"])
                await async_method(channel_id="C123")
            elif method_name == "codeChannels_create":
                self.api_methods_to_call.remove(
            ...
            elif method_name == "codeChannels_getCanvas":
                self.api_methods_to_call.remove(method(channel_id="C123", canvas_id="F123")["method"])
                await async_method(channel_id="C123", canvas_id="F123")
            elif method_name == "codeChannels_listViews":
                self.api_methods_to_call.remove(method(channel_id="C123")["method"])
                await async_method(channel_id="C123")
            elif method_name == "codeChannels_removeView":
            ...
            elif method_name == "codeChannels_rename":
                self.api_methods_to_call.remove(method(channel_id="C123", name="new-name")["method"])
                await async_method(channel_id="C123", name="new-name")
            elif method_name == "codeChannels_setCanvasContent":
                self.api_methods_to_call.remove(method(channel_id="C123", canvas_id="F123", content="# Plan")["method"])
                await async_method(channel_id="C123", canvas_id="F123", content="# Plan")
            elif method_name == "codeChannels_setCommands":
                self.api_methods_to_call.remove(method(channel_id="C123", commands=[])["method"])
                await async_method(channel_id="C123", commands=[])
            elif method_name == "codeChannels_setProperties":
                self.api_methods_to_call.remove(method(channel_id="C123")["method"])
                await async_method(channel_id="C123")
            elif method_name == "codeChannels_setView":
