...
class TestWebClientCoverage(unittest.TestCase):
    # 230 endpoints as of Dec 11, 2020
        ...
        for api_method in self.all_api_methods:
            ...
            if callable(method):
                if method_name == "admin_analytics_getFile":
                    ...
                    await async_method(
                        team_domain="awesome-team", team_name="Awesome Team"
                    )
                    ...
                    method(
                        usergroup_id="S123", include_num_members=True, team_id="T123"
                    )
                    method(usergroup_id="S123", include_num_members="1", team_id="T123")
                    method(usergroup_id="S123", include_num_members=1, team_id="T123")
                    method(
                        usergroup_id="S123", include_num_members=False, team_id="T123"
                    )
                    ...
                    await async_method(
                        team_id="T123", user_id="W123", expiration_ts=123
                    )
                    ...
                    method(channel="C123", users="U2345678901,U3456789012")
                    await async_method(
                        channel="C123", users=["U2345678901", "U3456789012"]
                    )
                    ...
                    await async_method(
                        workflow_step_edit_id="S789", inputs={}, outputs=[]
                    )
                    ...
                    self.api_methods_to_call.remove(
                        method(channel_id="D123", group_id="G123", team_id="T13")[
                            "method"
                        ]
                    )
                    await async_method(
                        channel_id="D123", group_id="G123", team_id="T123"
                    )
