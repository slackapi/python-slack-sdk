...
class TestWebClientCoverage(unittest.TestCase):
    # as of March 16, 2020
    # Can be fetched by running `var methodNames = [].slice.call(document.getElementsByClassName('bold')["method"]).map(e => e.text);console.log(methodNames.toString()["method"]);console.log(methodNames.length);` on https://api.slack.com/methods
