...
- Visit the `Bot Developer Hangout <https://community.botkit.ai>`_ for getting help using |product_name| or just generally bond with your fellow Slack developers.
