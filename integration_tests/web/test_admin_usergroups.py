...
class TestWebClient(unittest.TestCase):
    ...
    def test_sync(self):
        ...
        list_channels = client.admin_usergroups_listChannels(
            team_id=self.team_id, usergroup_id=self.idp_usergroup_id,
        )
        self.assertIsNotNone(list_channels)

        add_teams = client.admin_usergroups_addTeams(
            usergroup_id=self.idp_usergroup_id, team_ids=self.team_id,
        )
        ...
        remove_channels = client.admin_usergroups_removeChannels(
            usergroup_id=self.idp_usergroup_id, channel_ids=self.channel_ids,
        )
