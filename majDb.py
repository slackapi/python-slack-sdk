...
if count == 1:
    l.sayFood("Bonjour ! Je suis fier de me présenter, je suis HungryBot, je vais vous guider tout au long de vos études en vous indiquant ce que vous pourrez manger de bon au RAK de TB !")
else:
    l.sayFood(choice(text)+"\nC'est la "+str(count)+"ème semaine que je suis à votre service.")
